...
parser.add_argument('-para', '--parameters', type=str, default="../Livox-SDK/ws_livox/data/pcdFiles/parameters/", help="Folder path to the parameters (intrinsic.txt and extrinsic.txt)")
