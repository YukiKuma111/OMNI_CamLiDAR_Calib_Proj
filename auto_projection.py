...
parser.add_argument('-img', '--image', type=str, default="img/", help="Directory containing image files")
parser.add_argument('-pcd', '--pointcloud', type=str, default="pcd/", help="Directory containing point cloud files")
...
parser.add_argument('-s', '--save', type=str, default="result/", help="Directory to save the projected images")
