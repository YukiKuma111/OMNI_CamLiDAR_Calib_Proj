...
void getOmniData(const string lidar_path, const string photo_path, const int width, const int height, vector<PnPData> &pData);  // Added by yuku
...
// modified by yuku
void getOmniData(const string lidar_path, const string photo_path, const int width, const int height, vector<PnPData> &pData) {
    ifstream inFile_lidar;
    ifstream inFile_photo;
